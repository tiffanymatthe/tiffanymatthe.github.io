    ...
    <article>
        <div class="w-full">
          <div class="w-full relative">
            ...
            <div v-if="post.color !== undefined" class="project-colour-block bottom-0 m-0 p-0 absolute block -z-50 overflow-hidden right-[-10vw] md:right-[-25vw] dark:brightness-[.5]" :style="`background-color:#${post.color}`"></div>
          </div>
